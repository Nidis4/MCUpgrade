...
function validation(){
    ...
    if(done_renovation_type & done_tm & done_renovation_works & done_email & done_tel ){
    	...
    	$.ajax({
                  ...
                  data:{renovation_type,tm,valEmail,tel,renovation_type,paint,porta_asfaleias,koyfomata,esoterikes_portes,ilektrologikes_ergasies,ydraulikes_ergasies,systimata_thermansis,dapeda,tzaki,tentes,budget,txt,select_sxedio,idioktitis_enikiasti,perioxi,episkepsi,anakainisi_pote},
...
jQuery(window).scroll(function() {
        if (jQuery(document).scrollTop() > 490) {
