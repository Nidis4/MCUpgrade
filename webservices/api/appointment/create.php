...
if($stmt){ 
    ...
    if(@$employersms){
			...
			$smsTexts = implode(' - ', [
				...
				'στις '.$Ftime.' ' .$fdate.'.',
				$address,
				'Γραμμή εξυπηρέτησης πελατών 2103009325 Η άποψή σας είναι πολύτιμη, Αξιολογήστε μας και κερδίστε αυτόματα έκπτωση 10€ για την επόμενη εργασία μέσω του myconstructor! goo.gl/WRGed8'
			]);
