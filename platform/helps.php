...
<html class="fixed sidebar-left-collapsed">
	...
	<body>
		<section class="body">
			...
			<?php
				include('header.php');
				echo $api_url.'help/read_paging.php';
				$helps = file_get_contents($api_url.'help/read_paging.php');
				$helpsPag = json_decode($helps, true); // decode the JSON into an associative array	
							...
							<div class="card-body" id='custSearch'>
								...
								<table class="table table-bordered table-striped mb-0" id="datatable-editable">
									...
									<tbody id="customers-table">
										<?php
										foreach ($helpsPag['records'] as $field => $value) {
											$id = $helpsPag['records'][$field]['id'];
											$name = $helpsPag['records'][$field]['name'];
											$help = $helpsPag['records'][$field]['help'];
											echo '<tr data-item-id="'.$id.'">
													  <td>'.$name.'</td>
													  <td>'.$help.'</td>
													  <td class="actions">
														<a href="help.php?id='.$id.'" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
													  </td>
												  </tr>';
										}
										?>										
