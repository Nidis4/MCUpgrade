...
<html class="fixed sidebar-left-collapsed">
	...
	<body>
		<section class="body">
			...
			<?php
				include('header.php');
				$professionals = file_get_contents($api_url.'webservices/api/professional/read_paging.php?verified=0');
							...
							<div class="card-body" id='profSearch'>
								...
								<div class="row">
									<div class="col-sm-4 offset-sm-4 text-center">
										<button type="button" class="mb-1 mt-4 mr-1 btn btn-warning" id="searchProfessional">Search</button>
									</div>
								</div>
								...
								<table class="table table-bordered table-striped mb-0" id="datatable-editable">
									...
									<tbody id="customers-table">
										<?php
										foreach ($professionalsPag['records'] as $field => $value) {
											$id = $professionalsPag['records'][$field]['id'];
											$name = $professionalsPag['records'][$field]['first_name']." ".$professionalsPag['records'][$field]['last_name'];
											$address = $professionalsPag['records'][$field]['address'];
											$mobile = $professionalsPag['records'][$field]['mobile'];
											$landline = $professionalsPag['records'][$field]['phone'];
											$admin_comments = $professionalsPag['records'][$field]['admin_comments'];
											...
											echo '<tr data-item-id="'.$id.'">
													  ...
													  <td class="actions">
														<a href="professional.php?id='.$id.'" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
													  </td>
												  </tr>';
