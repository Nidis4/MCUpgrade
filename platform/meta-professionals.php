					...
					<div class="row">
						...
						<div class="col">
							...
							<div class="accordion" id="accordion">
								<?php
									$applications = file_get_contents($api_url.'professional/read_verified.php');
									...
									foreach ($applicationsPag['records'] as $field => $value) {
										...
										$fullname = $applicationsPag['records'][$field]['first_name']." ".$applicationsPag['records'][$field]['last_name'];
										...
										<div class='card card-default'>
											...
											<div id='collapse1".$id."' class='collapse' style=''>
												<div class='card-body'>
													...
													<p><button type='button' class='mb-1 mt-4 mr-1 btn btn-warning updatePro' id='updatePro".$id."'>Update</button></p>
												</div>
											</div>
										</div>
										";
