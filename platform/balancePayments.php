				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						<section class="card">
							...
							<div class="card-body">
								<form action="balancePayments.php" method="GET" id="">
								<div class="row">
									<div class="col-sm-5">
									</div>
									<div class="col-sm-7">
									...
									<tbody>
										...
										if(@$balancePag['records']){
											...
											foreach ($balancePag['records'] as $field => $value) {	
												...
												if($value['type'] == "Bank Transfer"){
													$bank_amount = $bank_amount + $value['amount'];
													$bank = "€".number_format($value['amount'],2);
												}elseif ($value['type'] == "Cash") {
													$cash_amount = $cash_amount + $value['amount'];
													$cash = "€".number_format($value['amount'],2);
												}

												echo '<tr data-item-id="'.$value['professionalId'].'">												  
														  <td>'.date("Y-m-d",strtotime($value['datetime_added'])).'</td>
										...
										?>
											<tr><th colspan="2">Totals</th><th ><?php echo "€".number_format($total_amount,2);?></th><th ><?php echo "€".number_format($cash_amount,2);?></th><th ><?php echo "€".number_format($bank_amount,2);?></th></tr>
										<?php
										}else{
										?>
